public class WrapperClassTest
{
	...
	public static void main(String[] args)
	{
		 ...
		 * argument Integer; a value less than 0
		 * 
		 * If this Integer is numerically less than the
		 * argument Integer; and a value greater than 0
		 * 
		 * If this Integer is numerically greater than the
		 * argument Integer (signed comparison).
		 */
