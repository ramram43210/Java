...
public class NonLambdaDemo
{
	public static void main(String[] args)
	{
		 ...
		 * begins with B.
		 */
		printNameBeginWith_B(personList,new Condition(){

			@Override
			public boolean test(Person p)
			{
				return p.getName().startsWith("B");
			}
	...
	private static void printNameBeginWith_B(List<Person> personList,Condition condition)
	{
