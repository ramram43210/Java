...
public class YearMonthDemo2
{
	public static void main(String[] args)
	{
		...
		YearMonth yearMonth2 = YearMonth.of(1990, Month.JANUARY);
		 ...
		 * 
		 * unit - the unit to measure the amount in, not
		 * nullReturns:the amount of time between this year-month and
		 * the end year-month
		 * 
		 * Returns:
		 * 
