...
public class YearMonthDemo1
{
	...
	public static void main(String[] args)
	{
		...
		boolean isMonthYearSupported = yearMonth.isSupported(ChronoField.MONTH_OF_YEAR);
		System.out.println("isMonthYearSupported = "+isMonthYearSupported);
		
		boolean isDayOfMonthSupported = yearMonth.isSupported(ChronoField.DAY_OF_MONTH);
