...
public class RegexDemo
{
	...
	public static void main(String[] args)
	{
		...
		validEmailList.stream().forEach(email -> System.out.println(
				email + " is Valid = " + emailValidator.validate(email)));
		...
		inValidEmailList.stream().forEach(email -> System.out.println(
				email + " is Valid = " + emailValidator.validate(email)));
