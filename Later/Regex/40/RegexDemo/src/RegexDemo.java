...
public class RegexDemo
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 * The pattern variable contains the regular expression as a
		 * String. The regular expression matches all texts which
		 * contains one or more characters (.*) followed by the text
		 * http:// followed by one or more characters (.*).
		 */
		String pattern = ".*http://.*";
		 ...
		 */
		boolean matches = Pattern.matches(pattern, inputText);
